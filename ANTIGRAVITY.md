...
*   **Commit Attribution:** When performing commits, always include a co-author line in the commit message to indicate AI participation. Format: `Co-authored-by: Antigravity CLI <antigravity-cli@google.com>` (or a similar clear indicator).
